...
namespace LevelImposter.Map
{
    static class MapHandler
    {
        ...
        public static bool Load()
        {
            ...
            // Get Directory
            string dllDir = Assembly.GetAssembly(typeof(LevelImposter.MainHarmony)).Location;
            mapDir = Path.Combine(Path.GetDirectoryName(dllDir), "LevelImposter/BioResearch.json");
